        ...
        <div class="grid_10">
            <div class="box round first">
                ...
                <div class="block">
                    <!-- paragraphs -->
                    <%
                        //COURSE coure = CourseAccess.GetCoursesByID(Request.Params.Get("courseId"));
                        COURSE course = (CourseAccess.GetAllCourses())[0];
                    %>
                    <p class="start">
                        <img src="img/vertical.jpg" alt="Ginger" class="right" /><%=course.INTRO %></p>
